...
function insertHtm(op,code,isStart){ 
	...
	insertHtm(document.body,'<iframe src="#" scrolling="no" class="WebFX-ContextMenu" marginwidth="0" marginheight="0" frameborder="0" style="position:absolute;display:none;z-index:50000000; height:316px;" id="WebFX_PopUp"></iframe>',true);
