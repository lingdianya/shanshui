...
function PutInfo($msg1,$msg2)
{
    ...
    $msginfo = "<html>\n<head>
        ...
        <br/>
        <div style='width:400px;height:30px;line-height:30px;font-size:12px;background-color:#FABC3D; color:#fff;box-shadow:0 0 4px rgba(0,0,0,0.2);'>提示信息</div>
        <div style='width:400px;height:100px;font-size:12px;background-color:#ffffff; color:#666; box-shadow: 0 0 4px rgba(0,0,0,0.2);'>
