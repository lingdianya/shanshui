...
else if($dopost=="make")
{
    ...
    if ($showmod == 1)
    {
        ...
        echo "<span style='color:#4BC30D; font-family:微软雅黑'>成功更新主页HTML：</span>".$homeFile."<a href='{$position}' target='_blank' style='font-size:18px; font-family:微软雅黑'>浏览...</a><br />";
    } else { 
        // 动态浏览
        if (file_exists($homeFile)) @unlink($homeFile);
        echo "<span style='color:#4BC30D; font-family:微软雅黑'>采用动态浏览模式：</span><a href='../index.php' target='_blank' style='font-size:18px; font-family:微软雅黑'>浏览...</a><br />";
    }
