...
?>
    <table width="100%" class="dboxtable" style="padding:0 0 5px 0;">
    <tr>
        <td width='50%' style="text-align:left; padding-left:12px; color:#666;"> 会员数： </td>
        <td style="text-align:left;"> <?php echo $row1['dd']; ?> </td>
    </tr>
    <tr>
        <td style="text-align:left;color:#666;padding-left:12px;"> 文档数： </td>
        <td style="text-align:left"> <?php echo $allArc; ?> </td>
    </tr>
    <?php
    ...
    ?>
    <tr>
        <td style="text-align:left;color:#666;padding-left:12px;"> <?php echo $row['typename']; ?>： </td>
        <td style="text-align:left"> <?php echo $row['dd']; ?>&nbsp; </td>
    </tr>
    <?php
    }
    ?>
    <tr>
        <td style="text-align:left;color:#666;padding-left:12px;"> 评论数： </td>
